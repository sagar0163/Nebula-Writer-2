...
from context_window import ContextWindow, build_system_prompt
            ...
            for pattern in patterns_list:
                if re.search(pattern, message_lower):
                    return ClassifiedIntent(
                        intent=intent_type,
                        confidence=0.8,
                        extracted_info=self._extract_info(message, intent_type)
                    )
...
Respond as: intent|confidence|{{"key": "value"}}
    ...
    def _handle_general_chat(self, message: str, intent: ClassifiedIntent, state: Dict) -> Dict:
        ...
        try:
            ...
            return {"message": "I'm here to help with your novel. You can ask me about characters, plot, or say 'write the next chapter'.", "actions": []}

...
class SupabaseDB:
    ...
    def update_chapter(self, chapter_id: int, content: str = None, title: str = None, summary: str = None) -> bool:
        ...
        result = self._request("PATCH", "chapters", data=data, filters={"id": chapter_id})
        return True
    ...
    def add_foreshadowing(self, plot_thread_id: int, chapter_id: int, content: str, hint_level: str = "subtle", payoff_chapter: int = None) -> str:
        data = {
    ...
    def add_consistency_issue(self, chapter_id: int = None, entity_id: int = None, issue_type: str = "", description: str = "", severity: str = "medium") -> str:
        data = {
            "chapter_id": chapter_id,
            "entity_id": entity_id,
    ...
    def add_relationship(self, from_id: int, to_id: int, rel_type: str, strength: float = 0.5, description: str = None) -> str:
        data = {

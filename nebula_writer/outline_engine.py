...
class EvolvingOutlineEngine:
    ...
    def _detect_seeds_from_prose(self, content: str):
        ...
        # Pre-compute lowercased seed contents to avoid O(n) lowercasing inside loops
            ...
            for pattern in seed_patterns:
                if pattern in sentence_lower and len(sentence) < 100:
                    ...
                    if not any(pattern in s_lower for s_lower in planted_seeds_lower):
                        ...
                        # Explicitly update cache since underlying list mutated
                        planted_seeds_lower.append(new_seed.lower())

...
class CodexDatabase:
    ...
    def run_consistency_check(self) -> List[Dict]:
        ...
        # Pre-compute chapter contents lowercased to avoid O(N*M) string manipulation overhead
        chapter_contents_lower = [
            chapter.get("content").lower() if chapter.get("content") else None for chapter in chapters
        ]

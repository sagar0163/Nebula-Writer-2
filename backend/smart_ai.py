...
from context_window import ContextWindow, truncate_context_for_budget
...
class SmartAIClient:
    ...
    def generate_with_context(self, intent: str, prompt: str, 
                            db, conversation_history: List[Dict] = None,

        ...
        for sentence in sentences:
            ...
            for pattern in seed_patterns:
                if pattern in sentence_lower:
                    ...
                    if not any(pattern in s_lower for s_lower in planted_seed_contents_lower):
                        new_seed_content = sentence.strip()[:100]
                        self.add_planted_seed(new_seed_content, self.current_chapter)
                        planted_seed_contents_lower.append(new_seed_content.lower())

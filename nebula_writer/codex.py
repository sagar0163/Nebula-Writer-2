...
class CodexDatabase:
    ...
    def _init_db(self):
        ...
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_events_chapter ON events(chapter)")
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_scenes_chapter ON scenes(chapter_id)")

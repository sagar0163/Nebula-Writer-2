...
class NarrativeDirector:
    ...
    def derive_directive(
        self, snapshot: NarrativeSnapshot, long_term_plan: Optional[Dict] = None
    ) -> NarrativeDirective:
        """
        ...
        primary_tension = (
            snapshot.unresolved_tensions[0] if snapshot.unresolved_tensions else {"description": "General development"}
        )
